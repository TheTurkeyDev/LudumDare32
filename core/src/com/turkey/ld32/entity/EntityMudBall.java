...
public class EntityMudBall extends Entity
{

	private float xVel;
	private float yVel;

	private Texture texture = new Texture("mudBall.png");

	public EntityMudBall(Room room, float x, float y, int width, int height, float xVel, float yVel)
	{
